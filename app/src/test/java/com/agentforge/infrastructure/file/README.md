...
```bash
# 在项目根目录运行
cd /Users/guide/Desktop/agentforge-interview
...
```bash
# 运行单元测试
./gradlew test --tests "com.agentforge.infrastructure.file.DocumentParseServiceTest"

# 运行集成测试
./gradlew test --tests "com.agentforge.infrastructure.file.DocumentParseIntegrationTest"
```
